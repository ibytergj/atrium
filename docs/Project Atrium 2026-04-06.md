...
│   └── som-inspector/                  # SOM Inspector (Sessions 19, 22, 23)
│       ├── index.html
│       └── src/
│           ├── app.js
│           ├── TreeView.js
...
- `.atrium.json` consumption by server (read config for `WORLD_PATH` +
  port from a single file)
